...
//      }
//
//      pub fn visit_label(&mut self, cfg: &Cfg, block: Label) {
...
//      pub fn visit_instr(&mut self, cfg: &Cfg, id: InstrId) {
...
//              self.visit_phi(phi.0, phi.1.clone());
//          } else if let Some(instr) = instr.downcast_ref::<GInstr>() {
//              match instr.clone() {
//                  GInstr::Move(v, l) =>
//                      self.visit_move(v, l),
...
//                  let mut instr = instr.downcast_ref::<GInstr>().unwrap().clone();
...
//                  }
//
//                  if let GInstr::Phi(_, vars) = &mut instr {
//                      let mut i: usize = 0;
//
//                      while i < vars.len() {
...
//                  }
//
//                  if let GInstr::Branch(_, l1, l2) = &instr
//                      && !self.visited.contains(l1) {
//                      instr = GInstr::Jump(*l2);
//                  }
//
//                  if let GInstr::Branch(_, l1, l2) = &instr
//                      && !self.visited.contains(l2) {
//                      instr = GInstr::Jump(*l1);
//                  }
//
//                  let used: bool =
